<div class="navbar navbar-inverse set-radius-zero" >
 ...
 <li>
                                ...
                                <ul class="dropdown-menu" role="menu" aria-labelledby="ddlmenuItem">
                                    ...
                                    <li role="presentation"><a role="menuitem" tabindex="-1" href="add-ebook.php">E-Book</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-books.php">Manage Books</a></li>
                                     <li role="presentation"><a role="menuitem" tabindex="-1" href="manage-ebooks.php">Manage E-Books</a></li>
